  ...
  return (
    ...
    >
      ...
      {visible && (
        <div
          ref={popoverRef}
          className="pointer-events-none absolute bottom-full left-0 z-30 mb-3 flex w-[320px]"
        >
          <div className="pointer-events-auto animate-nudge-in relative flex w-full items-start gap-3 rounded-2xl border border-edge-soft bg-elevated/95 px-4 py-3.5 backdrop-blur-md shadow-[0_18px_50px_-20px_rgba(0,0,0,0.65)]">
            <div className="flex min-w-0 flex-1 flex-col gap-1.5">
              <p className="text-[13px] font-semibold text-ink">Auto-loading the best stream</p>
            ...
            <div className="absolute left-10 top-full -mt-1.5 h-3 w-3 rotate-45 border-b border-r border-edge-soft bg-elevated/95" />
          </div>
        </div>
      )}
    </span>

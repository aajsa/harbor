...
export function UpcomingCta({ detail, onTry }: { detail: TmdbDetail | null; onTry: () => void }) {
  ...
  const friendly = upcomingDateLabel(date);
  return (
    <Tooltip label="Not officially released yet. Click to search anyway in case of an early release.">
      <button
        onClick={onTry}
...
function upcomingDateLabel(date: string | null | undefined): string | null {

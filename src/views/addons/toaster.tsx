...
export function Toaster({ toast }: { toast: ToastInfo | null }) {
  ...
  return (
    <div className="pointer-events-none fixed bottom-6 left-1/2 z-[160] -translate-x-1/2 animate-popover-in">
      <div
        className={`pointer-events-auto flex items-center gap-2.5 rounded-full border bg-elevated/95 py-1.5 pl-1.5 pr-4 shadow-[0_18px_50px_-20px_rgba(0,0,0,0.7)] backdrop-blur-md ${

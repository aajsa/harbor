...
const ROOT_VIEW_BY_KIND: Record<Frame["kind"], View | null> = {
  home: "home", settings: "settings", anime: "anime", discover: "discover",
  catalogs: "catalogs", addons: "addons", "addon-detail": "addons",
  calendar: "calendar", wrapped: "wrapped", queue: "discover", movies: "movies",
  shows: "shows", kids: "kids", library: "library", live: "live", vod: "vod",
  downloads: "downloads", service: null, meta: null, "episode-detail": null,
  person: null, collection: null, collections: null, filter: null, grid: null,
  award: null, "anime-award": null, picker: null, player: null, "match-detail": null,
};

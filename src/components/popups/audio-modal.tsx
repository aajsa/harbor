...
export function AudioModal({ state, onSelect, onDelay, onClose }: Props) {
  return (
    ...
    >
      <div
        className="m-3 mb-[110px] mr-[160px] flex max-h-[480px] w-[340px] flex-col overflow-hidden rounded-2xl border border-white/15 bg-black/92 shadow-[0_24px_60px_-15px_rgba(0,0,0,0.85)] backdrop-blur-xl"

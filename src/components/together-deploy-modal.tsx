        ...
        {phase === "intro" && (
          <div className="flex flex-col gap-4">
            ...
            <ol className="flex flex-col gap-3">
              <Step n={1}>
                <Interpolate text={t("Sign in, select {b1}, then select {b2} under {b3}.")} values={{
              ...
              <Step n={2}>
                <Interpolate text={t("Under Permissions, add one permission and set it to {b1} → {b2} → {b3}.")} values={{
                  b1: <b>{t("Account")}</b>,

...
export function TogetherParticipantLeftToast() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-6 z-[125] flex justify-center px-6">
      <div className="harbor-together-pill pointer-events-auto flex items-center gap-3 rounded-full border border-edge bg-surface/98 py-2 pl-2 pr-4 shadow-[0_24px_60px_-15px_rgba(0,0,0,0.75)] animate-popover-in">
        <span

    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        <h1 className="font-display text-[36px] font-medium leading-[1.08] tracking-tight text-ink">
          Pick your subtitle languages
        </h1>
        <p className="text-[15px] leading-relaxed text-ink-muted">
          When playback starts, Harbor finds and loads a subtitle in one of these languages
          automatically. The first available match wins, so put your main language first.
        </p>
      </div>
      <LanguagesPicker

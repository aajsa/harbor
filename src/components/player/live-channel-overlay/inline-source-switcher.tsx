  ...
  return (
    <div ref={wrapRef} className="relative shrink-0">
      ...
      >
        ...
        <span className="max-w-[200px] truncate">{active?.name ?? "Pick playlist"}</span>
        <ChevronDown
          size={15}
          strokeWidth={2}
      ...
      {open && (
        <div className="absolute left-0 top-[calc(100%+8px)] z-[100] w-[300px] overflow-hidden rounded-2xl border border-edge-soft bg-elevated shadow-[0_18px_50px_-15px_rgba(0,0,0,0.6)]">
